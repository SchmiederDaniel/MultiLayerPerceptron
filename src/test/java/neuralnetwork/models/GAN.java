...
//    LossFunction generatorLoss = new AbsoluteLoss();
    ...
    public void train() {
      ...
      float[] generatedData = generator.predict(NumpyArray.of(noiseData)).transpose().data[0][0];
      ...
      float discriminated = discriminator.predict(NumpyArray.of(discriminatorInput)).data[0][0][0];
...
//      discriminatorInput = new float[generatedData.length + 10];
    ...
    public void paint(Graphics graphics) {
      ...
      float[] generatedData = generator.predictThreadSafe(thinkInput).transpose().data[0][0];
