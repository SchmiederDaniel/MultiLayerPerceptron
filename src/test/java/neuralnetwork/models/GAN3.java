...
//          .layer.dropOut(0.8f)
    ...
    public void train() {
      ...
      float discriminated = discriminator.predict(NumpyArray.of(generatedData)).data[0][0][0];
    ...
    public void paint(Graphics graphics) {
      ...
      float[] generatedData = generator.predictThreadSafe(noiseThink).transpose().data[0][0];
